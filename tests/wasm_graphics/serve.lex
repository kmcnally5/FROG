...
s.get("/proof.html",   base.logged(_scriptDir() + "/proof.html"))
s.get("/proof.lex",    base.logged(_scriptDir() + "/proof.lex"))
...
println("  kitchen-sink demo : http://localhost:" + str(PORT) + "/")
println("  new-builtins proof: http://localhost:" + str(PORT) + "/proof.html")
