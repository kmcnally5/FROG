...
let categories = ["Bug Report", "Feature Request", "Question", "Documentation", "Other"]
let fruits     = ["Apple", "Banana", "Cherry", "Date", "Elderberry",
              "Fig", "Grape", "Honeydew", "Kiwi", "Lemon",
              "Mango", "Nectarine", "Orange", "Papaya"]
let tabLabels  = ["Inputs", "Selection", "Progress", "Notes", "Table", "Advanced"]

// Table data
let tableHeaders = ["Name", "Role", "Status"]
let tableRows    = [
...
let menuX    = 0
let menuY    = 0
let menuItems = ["Edit", "Duplicate", "Delete", "---", "Properties"]
let menuResult = -1
...
let cpB = 1.0
let cpA = 1.0
let cpResult = [0.45, 0.72, 1.0, 1.0]

// Tree view
let treeLabels   = ["Documents", "Projects", "kLex", "src", "tests",
                "stdlib", "Notes", "Archive", "2024", "2025"]
let treeLevels   = [0, 0, 1, 2, 2, 2, 0, 0, 1, 1]
let treeExpanded = [false, true, true, false, false, false, false, true, false, false]
let treeSel      = 0

// Scroll area
let scrollOffset = 0.0
let scrollItems  = ["Item 01", "Item 02", "Item 03", "Item 04", "Item 05",
...
window(980, 720, "kLex — Builtin UI Widgets", fn(frame) {
    ...
    if activeTab == 4 {
        ...
        if tableSelected >= 0 && tableSelected < len(tableRows) {
            let row = tableRows[tableSelected]
    ...
    if activeTab == 5 {
        ...
        let tvResult     = treeView(420, 98, 260, 360, treeLabels, treeLevels, treeExpanded, 0.65)
        treeSel      = tvResult[0]
