...
if err != null {
    ...
    let result, cerr = bridgeCall(bridge, "hang_forever", [])
    let timeoutFired = cerr != null && cerr.code == "BRIDGE_TIMEOUT"
    ...
    let result2, cerr2 = bridgeCall(bridge, "echo", ["after timeout"])
    let taintedFired = cerr2 != null && cerr2.code == "BRIDGE_TAINTED"
...
if err != null {
    ...
    let result, cerr = bridgeCall(bridge, "hang_forever", [], 1)
    let overrodeOk = cerr != null && cerr.code == "BRIDGE_TIMEOUT"
...
if err != null {
    ...
    let result, cerr = bridgeCall(bridge, "crash_with_traceback", [])
    ...
    let stderrLines = bridgeStderr(bridge)
...
if err != null {
    ...
    let result, cerr = bridgeCall(bridge, "kill_self", [])
