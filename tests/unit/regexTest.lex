import "stdlib/regex.lex" as regex

// --- match ---
let ok, err = regex.match("[0-9]+", "abc123")
...
// --- find ---
let m, err = regex.find("[0-9]+", "abc123def456")
if err != null { println(err)  return null }
...
// --- findAll ---
let all, err = regex.findAll("[0-9]+", "abc123def456ghi789")
if err != null { println(err)  return null }
...
// --- replace ---
let result, err = regex.replace("[0-9]+", "abc123def456", "NUM")
if err != null { println(err)  return null }
...
// --- split ---
let parts, err = regex.split(",\\s*", "a, b,c,  d")
if err != null { println(err)  return null }
...
// --- groups ---
let g, err = regex.groups("([a-z]+)([0-9]+)", "abc123")
if err != null { println(err)  return null }
