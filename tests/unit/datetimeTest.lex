...
let ts = dt.fromUnix(1705320000)
println(ts.year)                       // 2024
println(ts.month)                      // 1
println(ts.day)                        // 15

// --- parse ---
let parsed, err = dt.parse("2024-06-01", dt.DATE)
...
// --- parse error ---
let bad, err = dt.parse("not-a-date", dt.DATE)
println(err != null)                   // true
println(bad == null)                   // true

// --- diffSeconds ---
let a = dt.fromUnix(1000)
let b = dt.fromUnix(400)
println(dt.diffSeconds(a, b))          // 600

// --- addSeconds ---
let c = dt.addSeconds(a, 60)
println(c.unix)                        // 1060

// --- isWeekend ---
// 2024-01-13 was a Saturday, unix = 1705104000
let sat = dt.fromUnix(1705104000)
println(dt.isWeekend(sat))             // true
// 2024-01-15 was a Monday, unix = 1705276800
let mon = dt.fromUnix(1705276800)
